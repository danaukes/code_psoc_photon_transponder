...
module top ;
    ...
    USBFS_v3_20_0 myUSB (
        .sof(Net_1),
        .vbusdet(1'b0));
    defparam myUSB.epDMAautoOptimization = 0;

    UART_v2_50_1 UART_photon (
        .cts_n(1'b0),
        .tx(Net_291),
        .rts_n(Net_292),
        .tx_en(Net_293),
        ...
        .rx_data(Net_301),
        .rx_clk(Net_302));
    defparam UART_photon.Address1 = 0;
    defparam UART_photon.Address2 = 0;
    defparam UART_photon.EnIntRXInterrupt = 0;
    defparam UART_photon.EnIntTXInterrupt = 0;
    defparam UART_photon.FlowControl = 0;
    defparam UART_photon.HalfDuplexEn = 0;
    defparam UART_photon.HwTXEnSignal = 1;
    defparam UART_photon.NumDataBits = 8;
    defparam UART_photon.NumStopBits = 1;
    defparam UART_photon.ParityType = 0;
    defparam UART_photon.RXEnable = 1;
    defparam UART_photon.TXEnable = 1;
